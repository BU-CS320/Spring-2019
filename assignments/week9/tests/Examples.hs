...
eqRes = 
    ...
    ResTwo ("\\x -> \\x -> x","\\y -> \\x -> y") ((bindToLam "x"(bindToLam "x"(mkFreeVar "x"))), (bindToLam "y"(bindToLam "x"(mkFreeVar "y")))) True,
    ...
    ResTwo ("\\z -> \\x -> x","\\x -> \\z -> x") ((bindToLam "z"(bindToLam "x"(mkFreeVar "x"))), (bindToLam "x"(bindToLam "z"(mkFreeVar "x")))) True,
    ResTwo ("\\z -> \\x -> x","\\y -> \\z -> y") ((bindToLam "z"(bindToLam "x"(mkFreeVar "x"))), (bindToLam "y"(bindToLam "z"(mkFreeVar "y")))) True,
    ...
    ResTwo ("\\y -> \\x -> x","\\x -> \\y -> x") ((bindToLam "y"(bindToLam "x"(mkFreeVar "x"))), (bindToLam "x"(bindToLam "y"(mkFreeVar "x")))) True,
    ...
    ResTwo ("\\z -> \\z -> x","\\z -> \\z -> x") ((bindToLam "z"(bindToLam "z"(mkFreeVar "x"))), (bindToLam "z"(bindToLam "z"(mkFreeVar "x")))) True,
    ResTwo ("\\z -> \\z -> x","\\y -> \\z -> x") ((bindToLam "z"(bindToLam "z"(mkFreeVar "x"))), (bindToLam "y"(bindToLam "z"(mkFreeVar "x")))) True,
    ResTwo ("\\z -> \\z -> x","\\z -> \\y -> x") ((bindToLam "z"(bindToLam "z"(mkFreeVar "x"))), (bindToLam "z"(bindToLam "y"(mkFreeVar "x")))) True,
    ResTwo ("\\z -> \\z -> x","\\y -> \\y -> x") ((bindToLam "z"(bindToLam "z"(mkFreeVar "x"))), (bindToLam "y"(bindToLam "y"(mkFreeVar "x")))) True,
    ResTwo ("(\\x -> x) x","(\\x -> x) x") (((bindToLam "x"(mkFreeVar "x")) `mkApp` (mkFreeVar "x")), ((bindToLam "x"(mkFreeVar "x")) `mkApp` (mkFreeVar "x"))) True,
    ResTwo ("\\y -> \\z -> x","\\z -> \\z -> x") ((bindToLam "y"(bindToLam "z"(mkFreeVar "x"))), (bindToLam "z"(bindToLam "z"(mkFreeVar "x")))) True,
    ResTwo ("\\y -> \\z -> x","\\y -> \\z -> x") ((bindToLam "y"(bindToLam "z"(mkFreeVar "x"))), (bindToLam "y"(bindToLam "z"(mkFreeVar "x")))) True,
    ResTwo ("\\y -> \\z -> x","\\z -> \\y -> x") ((bindToLam "y"(bindToLam "z"(mkFreeVar "x"))), (bindToLam "z"(bindToLam "y"(mkFreeVar "x")))) True,
    ResTwo ("\\y -> \\z -> x","\\y -> \\y -> x") ((bindToLam "y"(bindToLam "z"(mkFreeVar "x"))), (bindToLam "y"(bindToLam "y"(mkFreeVar "x")))) True,
    ResTwo ("x x (\\x -> x)","x x (\\x -> x)") ((((mkFreeVar "x") `mkApp` (mkFreeVar "x")) `mkApp` (bindToLam "x"(mkFreeVar "x"))), (((mkFreeVar "x") `mkApp` (mkFreeVar "x")) `mkApp` (bindToLam "x"(mkFreeVar "x")))) True,
    ResTwo ("\\x -> y x","\\x -> y x") ((bindToLam "x"((mkFreeVar "y") `mkApp` (mkFreeVar "x"))), (bindToLam "x"((mkFreeVar "y") `mkApp` (mkFreeVar "x")))) True,
    ResTwo ("z (\\x -> x)","z (\\x -> x)") (((mkFreeVar "z") `mkApp` (bindToLam "x"(mkFreeVar "x"))), ((mkFreeVar "z") `mkApp` (bindToLam "x"(mkFreeVar "x")))) True,
    ResTwo ("\\z -> y x","\\z -> y x") ((bindToLam "z"((mkFreeVar "y") `mkApp` (mkFreeVar "x"))), (bindToLam "z"((mkFreeVar "y") `mkApp` (mkFreeVar "x")))) True,
    ResTwo ("y (\\x -> x)","y (\\x -> x)") (((mkFreeVar "y") `mkApp` (bindToLam "x"(mkFreeVar "x"))), ((mkFreeVar "y") `mkApp` (bindToLam "x"(mkFreeVar "x")))) True,
    ResTwo ("\\y -> y x","\\y -> y x") ((bindToLam "y"((mkFreeVar "y") `mkApp` (mkFreeVar "x"))), (bindToLam "y"((mkFreeVar "y") `mkApp` (mkFreeVar "x")))) True,
    ResTwo ("\\y -> y x","\\z -> z x") ((bindToLam "y"((mkFreeVar "y") `mkApp` (mkFreeVar "x"))), (bindToLam "z"((mkFreeVar "z") `mkApp` (mkFreeVar "x")))) True,
    ResTwo ("x","y z") ((mkFreeVar "x"), ((mkFreeVar "y") `mkApp` (mkFreeVar "z"))) False,
    ResTwo ("x","\\x -> y y") ((mkFreeVar "x"), (bindToLam "x"((mkFreeVar "y") `mkApp` (mkFreeVar "y")))) False,
    ResTwo ("x","x (\\x -> x)") ((mkFreeVar "x"), ((mkFreeVar "x") `mkApp` (bindToLam "x"(mkFreeVar "x")))) False,
    ResTwo ("x","\\y -> \\x -> y") ((mkFreeVar "x"), (bindToLam "y"(bindToLam "x"(mkFreeVar "y")))) False,
    ResTwo ("x","(\\z -> x) y") ((mkFreeVar "x"), ((bindToLam "z"(mkFreeVar "x")) `mkApp` (mkFreeVar "y"))) False,
    ResTwo ("y","x x") ((mkFreeVar "y"), ((mkFreeVar "x") `mkApp` (mkFreeVar "x"))) False,
    ResTwo ("y","\\y -> z") ((mkFreeVar "y"), (bindToLam "y"(mkFreeVar "z"))) False,
    ResTwo ("y","(\\x -> x) (x x)") ((mkFreeVar "y"), ((bindToLam "x"(mkFreeVar "x")) `mkApp` ((mkFreeVar "x") `mkApp` (mkFreeVar "x")))) False,
    ResTwo ("y","\\z -> \\y -> x") ((mkFreeVar "y"), (bindToLam "z"(bindToLam "y"(mkFreeVar "x")))) False,
    ResTwo ("y","y (y y)") ((mkFreeVar "y"), ((mkFreeVar "y") `mkApp` ((mkFreeVar "y") `mkApp` (mkFreeVar "y")))) False,
    ResTwo ("y","\\x -> \\y -> y") ((mkFreeVar "y"), (bindToLam "x"(bindToLam "y"(mkFreeVar "y")))) False,
    ResTwo ("z","\\z -> x") ((mkFreeVar "z"), (bindToLam "z"(mkFreeVar "x"))) False,
    ResTwo ("z","x x z") ((mkFreeVar "z"), (((mkFreeVar "x") `mkApp` (mkFreeVar "x")) `mkApp` (mkFreeVar "z"))) False,
    ResTwo ("z","\\x -> \\z -> x") ((mkFreeVar "z"), (bindToLam "x"(bindToLam "z"(mkFreeVar "x")))) False,
    ResTwo ("z","y y (x x)") ((mkFreeVar "z"), (((mkFreeVar "y") `mkApp` (mkFreeVar "y")) `mkApp` ((mkFreeVar "x") `mkApp` (mkFreeVar "x")))) False,
    ResTwo ("z","\\y -> z z") ((mkFreeVar "z"), (bindToLam "y"((mkFreeVar "z") `mkApp` (mkFreeVar "z")))) False,
    ResTwo ("z","(\\x -> x) (\\z -> x)") ((mkFreeVar "z"), ((bindToLam "x"(mkFreeVar "x")) `mkApp` (bindToLam "z"(mkFreeVar "x")))) False,
    ResTwo ("x x","x y") (((mkFreeVar "x") `mkApp` (mkFreeVar "x")), ((mkFreeVar "x") `mkApp` (mkFreeVar "y"))) False,
    ResTwo ("x x","\\y -> x x") (((mkFreeVar "x") `mkApp` (mkFreeVar "x")), (bindToLam "y"((mkFreeVar "x") `mkApp` (mkFreeVar "x")))) False,
    ResTwo ("x x","(\\x -> x) x") (((mkFreeVar "x") `mkApp` (mkFreeVar "x")), ((bindToLam "x"(mkFreeVar "x")) `mkApp` (mkFreeVar "x"))) False,
    ResTwo ("x x","\\z -> x y") (((mkFreeVar "x") `mkApp` (mkFreeVar "x")), (bindToLam "z"((mkFreeVar "x") `mkApp` (mkFreeVar "y")))) False,
    ResTwo ("x x","(\\z -> x) (y y)") (((mkFreeVar "x") `mkApp` (mkFreeVar "x")), ((bindToLam "z"(mkFreeVar "x")) `mkApp` ((mkFreeVar "y") `mkApp` (mkFreeVar "y")))) False,
    ResTwo ("x x","\\x -> z x") (((mkFreeVar "x") `mkApp` (mkFreeVar "x")), (bindToLam "x"((mkFreeVar "z") `mkApp` (mkFreeVar "x")))) False,
    ResTwo ("\\x -> x","\\z -> y") ((bindToLam "x"(mkFreeVar "x")), (bindToLam "z"(mkFreeVar "y"))) False,
    ResTwo ("\\x -> x","y (x x)") ((bindToLam "x"(mkFreeVar "x")), ((mkFreeVar "y") `mkApp` ((mkFreeVar "x") `mkApp` (mkFreeVar "x")))) False,
    ResTwo ("\\x -> x","\\z -> y x") ((bindToLam "x"(mkFreeVar "x")), (bindToLam "z"((mkFreeVar "y") `mkApp` (mkFreeVar "x")))) False,
    ResTwo ("\\x -> x","(\\x -> x) (y y)") ((bindToLam "x"(mkFreeVar "x")), ((bindToLam "x"(mkFreeVar "x")) `mkApp` ((mkFreeVar "y") `mkApp` (mkFreeVar "y")))) False,
    ResTwo ("\\x -> x","\\x -> z y") ((bindToLam "x"(mkFreeVar "x")), (bindToLam "x"((mkFreeVar "z") `mkApp` (mkFreeVar "y")))) False,
    ResTwo ("\\x -> x","x (\\z -> x)") ((bindToLam "x"(mkFreeVar "x")), ((mkFreeVar "x") `mkApp` (bindToLam "z"(mkFreeVar "x")))) False,
    ResTwo ("y y","y z") (((mkFreeVar "y") `mkApp` (mkFreeVar "y")), ((mkFreeVar "y") `mkApp` (mkFreeVar "z"))) False,
    ResTwo ("y y","\\x -> y y") (((mkFreeVar "y") `mkApp` (mkFreeVar "y")), (bindToLam "x"((mkFreeVar "y") `mkApp` (mkFreeVar "y")))) False,
    ResTwo ("y y","x (\\x -> x)") (((mkFreeVar "y") `mkApp` (mkFreeVar "y")), ((mkFreeVar "x") `mkApp` (bindToLam "x"(mkFreeVar "x")))) False,
    ResTwo ("y y","\\y -> \\x -> y") (((mkFreeVar "y") `mkApp` (mkFreeVar "y")), (bindToLam "y"(bindToLam "x"(mkFreeVar "y")))) False,
    ResTwo ("y y","(\\z -> x) y") (((mkFreeVar "y") `mkApp` (mkFreeVar "y")), ((bindToLam "z"(mkFreeVar "x")) `mkApp` (mkFreeVar "y"))) False,
    ResTwo ("\\z -> x","z") ((bindToLam "z"(mkFreeVar "x")), (mkFreeVar "z")) False,
    ResTwo ("\\z -> x","x x (x x)") ((bindToLam "z"(mkFreeVar "x")), (((mkFreeVar "x") `mkApp` (mkFreeVar "x")) `mkApp` ((mkFreeVar "x") `mkApp` (mkFreeVar "x")))) False,
    ResTwo ("\\z -> x","\\y -> y y") ((bindToLam "z"(mkFreeVar "x")), (bindToLam "y"((mkFreeVar "y") `mkApp` (mkFreeVar "y")))) False,
    ResTwo ("\\z -> x","y y (\\x -> x)") ((bindToLam "z"(mkFreeVar "x")), (((mkFreeVar "y") `mkApp` (mkFreeVar "y")) `mkApp` (bindToLam "x"(mkFreeVar "x")))) False,
    ResTwo ("\\z -> x","\\z -> z z") ((bindToLam "z"(mkFreeVar "x")), (bindToLam "z"((mkFreeVar "z") `mkApp` (mkFreeVar "z")))) False,
    ResTwo ("\\z -> x","y y (\\z -> x)") ((bindToLam "z"(mkFreeVar "x")), (((mkFreeVar "y") `mkApp` (mkFreeVar "y")) `mkApp` (bindToLam "z"(mkFreeVar "x")))) False,
    ResTwo ("y x","\\z -> x") (((mkFreeVar "y") `mkApp` (mkFreeVar "x")), (bindToLam "z"(mkFreeVar "x"))) False,
    ResTwo ("y x","\\z -> x x") (((mkFreeVar "y") `mkApp` (mkFreeVar "x")), (bindToLam "z"((mkFreeVar "x") `mkApp` (mkFreeVar "x")))) False,
    ResTwo ("y x","(\\x -> x) y") (((mkFreeVar "y") `mkApp` (mkFreeVar "x")), ((bindToLam "x"(mkFreeVar "x")) `mkApp` (mkFreeVar "y"))) False,
    ResTwo ("y x","\\x -> x y") (((mkFreeVar "y") `mkApp` (mkFreeVar "x")), (bindToLam "x"((mkFreeVar "x") `mkApp` (mkFreeVar "y")))) False,
    ResTwo ("y x","(\\z -> x) (\\z -> x)") (((mkFreeVar "y") `mkApp` (mkFreeVar "x")), ((bindToLam "z"(mkFreeVar "x")) `mkApp` (bindToLam "z"(mkFreeVar "x")))) False,
    ResTwo ("y x","\\y -> \\y -> y") (((mkFreeVar "y") `mkApp` (mkFreeVar "x")), (bindToLam "y"(bindToLam "y"(mkFreeVar "y")))) False,
    ResTwo ("\\y -> x","z z") ((bindToLam "y"(mkFreeVar "x")), ((mkFreeVar "z") `mkApp` (mkFreeVar "z"))) False,
    ResTwo ("\\y -> x","\\x -> \\x -> x") ((bindToLam "y"(mkFreeVar "x")), (bindToLam "x"(bindToLam "x"(mkFreeVar "x")))) False,
    ResTwo ("\\y -> x","x x (\\x -> x)") ((bindToLam "y"(mkFreeVar "x")), (((mkFreeVar "x") `mkApp` (mkFreeVar "x")) `mkApp` (bindToLam "x"(mkFreeVar "x")))) False,
    ResTwo ("\\y -> x","\\y -> x y") ((bindToLam "y"(mkFreeVar "x")), (bindToLam "y"((mkFreeVar "x") `mkApp` (mkFreeVar "y")))) False,
    ResTwo ("\\y -> x","(\\z -> x) (\\x -> x)") ((bindToLam "y"(mkFreeVar "x")), ((bindToLam "z"(mkFreeVar "x")) `mkApp` (bindToLam "x"(mkFreeVar "x")))) False,
    ResTwo ("\\y -> x","\\z -> z x") ((bindToLam "y"(mkFreeVar "x")), (bindToLam "z"((mkFreeVar "z") `mkApp` (mkFreeVar "x")))) False,
    ResTwo ("x y","\\y -> y") (((mkFreeVar "x") `mkApp` (mkFreeVar "y")), (bindToLam "y"(mkFreeVar "y"))) False,
    ResTwo ("x y","y (x x)") (((mkFreeVar "x") `mkApp` (mkFreeVar "y")), ((mkFreeVar "y") `mkApp` ((mkFreeVar "x") `mkApp` (mkFreeVar "x")))) False,
    ResTwo ("x y","\\z -> y x") (((mkFreeVar "x") `mkApp` (mkFreeVar "y")), (bindToLam "z"((mkFreeVar "y") `mkApp` (mkFreeVar "x")))) False,
    ResTwo ("x y","(\\x -> x) (y y)") (((mkFreeVar "x") `mkApp` (mkFreeVar "y")), ((bindToLam "x"(mkFreeVar "x")) `mkApp` ((mkFreeVar "y") `mkApp` (mkFreeVar "y")))) False,
    ResTwo ("x y","\\x -> z y") (((mkFreeVar "x") `mkApp` (mkFreeVar "y")), (bindToLam "x"((mkFreeVar "z") `mkApp` (mkFreeVar "y")))) False,
    ResTwo ("x y","x (\\z -> x)") (((mkFreeVar "x") `mkApp` (mkFreeVar "y")), ((mkFreeVar "x") `mkApp` (bindToLam "z"(mkFreeVar "x")))) False,
    ResTwo ("\\x -> y","\\z -> z") ((bindToLam "x"(mkFreeVar "y")), (bindToLam "z"(mkFreeVar "z"))) False,
    ResTwo ("\\x -> y","(\\x -> x) (\\x -> x)") ((bindToLam "x"(mkFreeVar "y")), ((bindToLam "x"(mkFreeVar "x")) `mkApp` (bindToLam "x"(mkFreeVar "x")))) False,
    ResTwo ("\\x -> y","\\x -> \\y -> x") ((bindToLam "x"(mkFreeVar "y")), (bindToLam "x"(bindToLam "y"(mkFreeVar "x")))) False,
    ResTwo ("\\x -> y","z (y y)") ((bindToLam "x"(mkFreeVar "y")), ((mkFreeVar "z") `mkApp` ((mkFreeVar "y") `mkApp` (mkFreeVar "y")))) False,
    ResTwo ("\\x -> y","\\y -> z y") ((bindToLam "x"(mkFreeVar "y")), (bindToLam "y"((mkFreeVar "z") `mkApp` (mkFreeVar "y")))) False,
    ResTwo ("z z","x x") (((mkFreeVar "z") `mkApp` (mkFreeVar "z")), ((mkFreeVar "x") `mkApp` (mkFreeVar "x"))) False,
    ResTwo ("z z","x x (x x)") (((mkFreeVar "z") `mkApp` (mkFreeVar "z")), (((mkFreeVar "x") `mkApp` (mkFreeVar "x")) `mkApp` ((mkFreeVar "x") `mkApp` (mkFreeVar "x")))) False,
    ResTwo ("z z","\\y -> y y") (((mkFreeVar "z") `mkApp` (mkFreeVar "z")), (bindToLam "y"((mkFreeVar "y") `mkApp` (mkFreeVar "y")))) False,
    ResTwo ("z z","y y (\\x -> x)") (((mkFreeVar "z") `mkApp` (mkFreeVar "z")), (((mkFreeVar "y") `mkApp` (mkFreeVar "y")) `mkApp` (bindToLam "x"(mkFreeVar "x")))) False,
    ResTwo ("z z","\\z -> z z") (((mkFreeVar "z") `mkApp` (mkFreeVar "z")), (bindToLam "z"((mkFreeVar "z") `mkApp` (mkFreeVar "z")))) False,
    ResTwo ("z z","y y (\\z -> x)") (((mkFreeVar "z") `mkApp` (mkFreeVar "z")), (((mkFreeVar "y") `mkApp` (mkFreeVar "y")) `mkApp` (bindToLam "z"(mkFreeVar "x")))) False,
    ResTwo ("\\z -> y","\\z -> x") ((bindToLam "z"(mkFreeVar "y")), (bindToLam "z"(mkFreeVar "x"))) False,
    ResTwo ("\\z -> y","x x y") ((bindToLam "z"(mkFreeVar "y")), (((mkFreeVar "x") `mkApp` (mkFreeVar "x")) `mkApp` (mkFreeVar "y"))) False,
    ResTwo ("\\z -> y","\\z -> \\z -> x") ((bindToLam "z"(mkFreeVar "y")), (bindToLam "z"(bindToLam "z"(mkFreeVar "x")))) False,
    ResTwo ("\\z -> y","y y z") ((bindToLam "z"(mkFreeVar "y")), (((mkFreeVar "y") `mkApp` (mkFreeVar "y")) `mkApp` (mkFreeVar "z"))) False,
    ResTwo ("\\z -> y","\\x -> \\z -> y") ((bindToLam "z"(mkFreeVar "y")), (bindToLam "x"(bindToLam "z"(mkFreeVar "y")))) False,
    ResTwo ("\\z -> y","x x (\\z -> x)") ((bindToLam "z"(mkFreeVar "y")), (((mkFreeVar "x") `mkApp` (mkFreeVar "x")) `mkApp` (bindToLam "z"(mkFreeVar "x")))) False,
    ResTwo ("z y","\\x -> y") (((mkFreeVar "z") `mkApp` (mkFreeVar "y")), (bindToLam "x"(mkFreeVar "y"))) False,
    ResTwo ("z y","\\x -> \\x -> x") (((mkFreeVar "z") `mkApp` (mkFreeVar "y")), (bindToLam "x"(bindToLam "x"(mkFreeVar "x")))) False,
    ResTwo ("z y","x x (\\x -> x)") (((mkFreeVar "z") `mkApp` (mkFreeVar "y")), (((mkFreeVar "x") `mkApp` (mkFreeVar "x")) `mkApp` (bindToLam "x"(mkFreeVar "x")))) False,
    ResTwo ("z y","\\y -> x y") (((mkFreeVar "z") `mkApp` (mkFreeVar "y")), (bindToLam "y"((mkFreeVar "x") `mkApp` (mkFreeVar "y")))) False,
    ResTwo ("z y","(\\z -> x) (\\x -> x)") (((mkFreeVar "z") `mkApp` (mkFreeVar "y")), ((bindToLam "z"(mkFreeVar "x")) `mkApp` (bindToLam "x"(mkFreeVar "x")))) False,
    ResTwo ("z y","\\z -> z x") (((mkFreeVar "z") `mkApp` (mkFreeVar "y")), (bindToLam "z"((mkFreeVar "z") `mkApp` (mkFreeVar "x")))) False,
    ResTwo ("\\y -> y","z x") ((bindToLam "y"(mkFreeVar "y")), ((mkFreeVar "z") `mkApp` (mkFreeVar "x"))) False,
    ResTwo ("\\y -> y","x (x x)") ((bindToLam "y"(mkFreeVar "y")), ((mkFreeVar "x") `mkApp` ((mkFreeVar "x") `mkApp` (mkFreeVar "x")))) False,
    ResTwo ("\\y -> y","\\y -> y x") ((bindToLam "y"(mkFreeVar "y")), (bindToLam "y"((mkFreeVar "y") `mkApp` (mkFreeVar "x")))) False,
    ResTwo ("\\y -> y","x x (y y)") ((bindToLam "y"(mkFreeVar "y")), (((mkFreeVar "x") `mkApp` (mkFreeVar "x")) `mkApp` ((mkFreeVar "y") `mkApp` (mkFreeVar "y")))) False,
    ResTwo ("\\y -> y","\\z -> z y") ((bindToLam "y"(mkFreeVar "y")), (bindToLam "z"((mkFreeVar "z") `mkApp` (mkFreeVar "y")))) False,
    ResTwo ("z x","y") (((mkFreeVar "z") `mkApp` (mkFreeVar "x")), (mkFreeVar "y")) False,
    ResTwo ("z x","x z") (((mkFreeVar "z") `mkApp` (mkFreeVar "x")), ((mkFreeVar "x") `mkApp` (mkFreeVar "z"))) False,
    ResTwo ("z x","\\z -> y y") (((mkFreeVar "z") `mkApp` (mkFreeVar "x")), (bindToLam "z"((mkFreeVar "y") `mkApp` (mkFreeVar "y")))) False,
    ResTwo ("z x","y y (y y)") (((mkFreeVar "z") `mkApp` (mkFreeVar "x")), (((mkFreeVar "y") `mkApp` (mkFreeVar "y")) `mkApp` ((mkFreeVar "y") `mkApp` (mkFreeVar "y")))) False,
    ResTwo ("z x","\\x -> z z") (((mkFreeVar "z") `mkApp` (mkFreeVar "x")), (bindToLam "x"((mkFreeVar "z") `mkApp` (mkFreeVar "z")))) False,
    ResTwo ("z x","(\\z -> x) x") (((mkFreeVar "z") `mkApp` (mkFreeVar "x")), ((bindToLam "z"(mkFreeVar "x")) `mkApp` (mkFreeVar "x"))) False,
    ResTwo ("\\x -> z","\\x -> x") ((bindToLam "x"(mkFreeVar "z")), (bindToLam "x"(mkFreeVar "x"))) False,
    ResTwo ("\\x -> z","x x z") ((bindToLam "x"(mkFreeVar "z")), (((mkFreeVar "x") `mkApp` (mkFreeVar "x")) `mkApp` (mkFreeVar "z"))) False,
    ResTwo ("\\x -> z","\\x -> \\z -> x") ((bindToLam "x"(mkFreeVar "z")), (bindToLam "x"(bindToLam "z"(mkFreeVar "x")))) False,
    ResTwo ("\\x -> z","y y (x x)") ((bindToLam "x"(mkFreeVar "z")), (((mkFreeVar "y") `mkApp` (mkFreeVar "y")) `mkApp` ((mkFreeVar "x") `mkApp` (mkFreeVar "x")))) False,
    ResTwo ("\\x -> z","\\y -> z z") ((bindToLam "x"(mkFreeVar "z")), (bindToLam "y"((mkFreeVar "z") `mkApp` (mkFreeVar "z")))) False,
    ResTwo ("\\x -> z","(\\x -> x) (\\z -> x)") ((bindToLam "x"(mkFreeVar "z")), ((bindToLam "x"(mkFreeVar "x")) `mkApp` (bindToLam "z"(mkFreeVar "x")))) False,
    ResTwo ("y z","\\y -> x") (((mkFreeVar "y") `mkApp` (mkFreeVar "z")), (bindToLam "y"(mkFreeVar "x"))) False,
    ResTwo ("y z","\\y -> x x") (((mkFreeVar "y") `mkApp` (mkFreeVar "z")), (bindToLam "y"((mkFreeVar "x") `mkApp` (mkFreeVar "x")))) False]
